package com.ingenio.gestion_logistica.config.properties;
...
import com.ingenio.gestion_logistica.util.ExceptionUtil;
import com.ingenio.gestion_logistica.util.SerialClone;
	...
	private Propiedad() {
		try {
			InputStream in = this.getClass()
					.getResourceAsStream("/com/ingenio/gestion_logistica/config//properties/version.properties");
			propVersion.load(in);
			in.close();

			in = this.getClass().getResourceAsStream("/com/ingenio/gestion_logistica/config/properties/param.properties");
			propGlobal.load(in);
			in.close();
